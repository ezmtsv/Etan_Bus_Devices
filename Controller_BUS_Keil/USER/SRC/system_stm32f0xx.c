...
#define VECT_TAB_OFFSET  0x200  //
/* Select the PLL clock source */

//#define SOURCE_HSI48
//#define PLL_SOURCE_HSI48       /* HSI48 (48MHz) used to clock USB, system clock and the PLL*// для работы без внешнего кварца
//#define PLL_SOURCE_HSI        /* HSI (~8MHz) used to clock the PLL, and the PLL is used as system clock source*/
#define PLL_SOURCE_HSE        /* HSE (8MHz) used to clock the PLL, and the PLL is used as system clock source *///для работы с внешним кварцем
